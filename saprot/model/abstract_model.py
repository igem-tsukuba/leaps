...
from saprot.utils.lr_scheduler import Esm2LRScheduler
...
class AbstractModel(pl.LightningModule):
    def __init__(
        ...
        self.lr_scheduler_kwargs = (
            {"init_lr": 0} if lr_scheduler_kwargs is None else lr_scheduler_kwargs
        )
    ...
    def load_checkpoint(self, from_checkpoint, load_prev_scheduler):
        ...
        if load_prev_scheduler:
            try:
                ...
                print(e)
                raise KeyError(
                    "Wrong in loading previous scheduler, please set load_prev_scheduler=False"
                )
